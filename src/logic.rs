...
state_machine! {
  ...
  Empty(ItemAdded) => InProgress [AddItem_DeleteItem_PayOrder],
  InProgress => {
    ItemDeleted => InProgress [AddItem_DeleteItem_PayOrder],
    LastItemDeleted => Empty [AddItem],
    OrderPayed => Payed [PrepareOrder],
    CustomerAdded => InProgress [AddItem_DeleteItem_PayOrder],
    OrderDetailsAdded => InProgress [AddItem_DeleteItem_PayOrder],
  },
  Payed => {
    OrderSent => Sent,
    ItemAdded => PayDiff,
